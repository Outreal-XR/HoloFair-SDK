...
namespace outrealxr.holomod
{
    public class SceneLoadingView : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            ProgressText.text = SceneController.currentlyLoading ? string.Format(ProgressFormat, SceneController.currentlyLoading.sceneName, ProgressAmountImage.fillAmount) : "Waiting...";
        }
    }
}